        ...
        <div class="form">
            ...
            <form method="post">
               ...
               <h4>Nom de Produit</h4>
                ...
                <input type="text" name="image" accept="">
...
<h4>Couleur</h4>
                ...
                <button type="submit" value="Ajouter un produit " name="valider">Ajouter un produit</button>
            </form>
        </div>
    </div>
    ...
    if(!empty($_POST['nom_P']) AND !empty($_POST['prix']) AND !empty($_POST['desc']) AND !empty($_POST['image']))
	    {
          ...
          try 
          {
            add_p($Nom_P,$Prix_P,$Description_P,$Image_P,$Couleur,$available );
